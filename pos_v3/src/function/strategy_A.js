...
function get_promotion_A() {
    ...
    var regulation_info_A = [
        ...
        },
        {
            ...
            name: '满100减3',
            discount_rate: {top: 100, reduce: 3},
            barcode: {besides_barcode: ['ITEM000005'], barcode: "all"},
            special:null
        }
    ];
    ...
    //);
    return Build_regulation_of_strategy(regulation_info_A);
}
